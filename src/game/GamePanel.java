...
public class GamePanel extends JPanel implements ActionListener, KeyListener, MouseListener, MouseMotionListener{
	...
	public static BufferedImage guy;
	...
	public GamePanel(){
		try{
			guy = ImageIO.read(this.getClass().getResourceAsStream("charachter.png"));
			bullet = ImageIO.read(this.getClass().getResourceAsStream("bullet.png"));
			alien = ImageIO.read(this.getClass().getResourceAsStream("alien2.png"));
			maze = ImageIO.read(this.getClass().getResourceAsStream("maze.png"));
		}catch(Exception e){
			
		}
		
		objManager = new ObjectManager();
		s = new ShipObject(20, 50, 16, 17);
	...
	public void paintComponent(Graphics g){
		if(currentState == menuState){
			...
			g.drawImage(maze, 0, 0, LeagueInvaders.WIDTH, LeagueInvaders.HEIGHT, null);
			objManager.draw(g);
